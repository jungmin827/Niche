...
from src.schemas.archive import MyArchiveResponse, UserArchiveResponse
...
@router.get("/users/{profile_id}/archive", response_model=UserArchiveResponse)
async def get_user_archive(
    ...
    result = await service.get_user_archive(
