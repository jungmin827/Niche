...
class ProfileTable(Base):
    ...
    current_rank_code: Mapped[str] = mapped_column(Text, nullable=False, server_default=text("'surface'"))
...
class ProfileStatsTable(Base):
    ...
    total_sessions: Mapped[int] = mapped_column(Integer, nullable=False, server_default=text("0"))
    total_focus_minutes: Mapped[int] = mapped_column(Integer, nullable=False, server_default=text("0"))
    total_blog_posts: Mapped[int] = mapped_column(Integer, nullable=False, server_default=text("0"))
    total_highlights: Mapped[int] = mapped_column(Integer, nullable=False, server_default=text("0"))
