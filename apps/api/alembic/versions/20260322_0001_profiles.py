...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("current_rank_code", sa.Text(), nullable=False, server_default=sa.text("'surface'")),
        sa.Column("rank_score", sa.Integer(), nullable=False, server_default=sa.text("0")),
    ...
    op.create_table(
        ...
        sa.Column("total_focus_minutes", sa.Integer(), nullable=False, server_default=sa.text("0")),
        sa.Column("total_blog_posts", sa.Integer(), nullable=False, server_default=sa.text("0")),
        sa.Column("total_highlights", sa.Integer(), nullable=False, server_default=sa.text("0")),
